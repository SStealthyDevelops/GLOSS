    ...
    <div className="min-h-screen bg-gloss-cream">
      ...
      <nav className="bg-white border-b border-gloss-offwhite py-4 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-serif font-bold text-gloss-navy">
              GLOSS
            </span>
          </div>
          ...
          <div className="flex flex-row items-center gap-6">
            <Link
              href="/music"
              className="group flex flex-row items-center gap-x-4 font-body-serif text-gloss-navy hover:text-gloss-gold transition-colors"
            >
                <Music className='w-6 h-6 text-gloss-navy group-hover:text-gloss-gold transition-colors'/>
              Sound Library
            </Link>
          </div>
        </div>
      ...
      <section className="relative bg-gradient-to-br from-gloss-navy via-gloss-blue to-gloss-accent py-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gloss-offwhite font-body-serif mb-8 max-w-3xl mx-auto">
            Expanding accessibility in sound and music for neurodivergent
            individuals
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gloss-slate font-body-serif leading-relaxed mb-6">
              ...
              <span className="font-semibold text-gloss-navy">
                Professor Andrew Hugill
              </span>{" "}
              as the Project Consultant for the Grainger Library of Sampled
              Sound (GLOSS).
            </p>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gloss-offwhite">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10 md:p-12">
            <p className="text-xl text-gloss-slate font-body-serif leading-relaxed mb-6">
              The current project is directed at expanding GLOSS for use by
              neurodivergent people working in sound and music. This encompasses
              a wide spectrum of individuals with unique cognitive profiles,
              including autism, ADHD, dyslexia, and other neurological
              differences.
            </p>
            <p className="text-xl text-gloss-slate font-body-serif leading-relaxed">
              Their needs often include tailored approaches to learning, sensory
              sensitivity considerations, and support in navigating the
              complexities of music and composing.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gloss-cream hover:bg-gloss-offwhite rounded-xl p-8 shadow-md hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gloss-slate font-body-serif leading-relaxed">
                Discover the collection of sampled sounds and musical resources
                available through GLOSS.
              </p>
            </div>
            ...
            <div className="bg-gloss-cream hover:bg-gloss-offwhite rounded-xl p-8 shadow-md hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gloss-slate font-body-serif leading-relaxed">
                Learn about the pioneering composer, ethnomusicologist, and
                innovator behind this collection.
              </p>
            </div>
            ...
            <div className="bg-gloss-cream hover:bg-gloss-offwhite rounded-xl p-8 shadow-md hover:shadow-xl transition-all cursor-pointer group">
              ...
              <p className="text-gloss-slate font-body-serif leading-relaxed">
                Explore the development process and vision behind creating this
                accessible sound library.
              </p>
            </div>
            ...
            <div className="bg-gloss-cream hover:bg-gloss-offwhite rounded-xl p-8 shadow-md hover:shadow-xl transition-all cursor-pointer group">
              <div className="w-16 h-16 bg-gloss-gold rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg
                  className="w-8 h-8 text-gloss-navy"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="text-gloss-slate font-body-serif leading-relaxed">
                Discover how Grainger&apos;s forward-thinking approach
                revolutionized music and sound collection.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gloss-navy">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gloss-offwhite font-body-serif mb-10 max-w-2xl mx-auto">
            Learn more about this innovative initiative to make music and sound
            creation accessible to neurodivergent individuals.
          </p>
          <a
      ...
      <footer className="bg-gloss-dark text-gloss-muted py-10 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-body-serif">© 2024 Percy Grainger Society. All rights reserved.</p>
